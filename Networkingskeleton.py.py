  ...
  def build(self):
    ...
    # self.addLink(s1,h2, port1=9, port2=0)
	 ...
	 h1 = self.addHost('h1', mac='00:00:00:00:00:01', ip='10.1.1.10/24', defaultRoute="h1-eth0")
  	 ...
  	 self.addLink(s1,s4, port1=4, port2=5)
  	 self.addLink(s2,s4, port1=4, port2=6)
  	 self.addLink(s3,s4, port1=4, port2=7)
  	 self.addLink(h4,s4, port1=0, port2=9)
  	 self.addLink(s4,s5, port1=8, port2=4)
